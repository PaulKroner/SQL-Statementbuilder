    ...
    <!-- Tab links -->
        ...
        <div id="Statementtyp" class="tabcontent">
            ...
            <div class="boxfield">
                ...
                <select name="StatementAuswahl" id="StatementAuswahl" class="statementTabellennamen" size=3 onchange="statementchange();">
        ...
        <div id="Zieltabelle" class="tabcontent">
            ...
            <div class="boxfield">
                ...
                <select name="tabellenAuswahl" id="tabellenAuswahl" class="tabellennamen" size=10 onchange="selectChoice()">
                <?php
            ...
            <div class="boxfield">
                ...
                <select name="felderAuswahl" id="felderAuswahl" class="tabellennamen" size=10 onchange="selectChoice()">
            ...
            <div class="boxfield" id="forUpdateOnly">
                ...
                <input type="text" maxlength=20 id="wertEingabeFelder" class="werte" oninput="selectChoice()">
            </div>
        ...
        <div id="bedingungenSelect" class="tabcontent">
            ...
            <div class="boxfield">
                ...
                <select id="bedingungenTabelle" size="10" class="tabellennamen" onchange="selectChoice()">
            ...
            <div class="boxfield">
                ...
                <select name="operatorBedingungen" id="operatorBedingungen" size="1" class="operator" onchange="selectChoice()">
            ...
            <div class="boxfield">
                <p class="infofelder"> Tragen Sie hier den Wert ein.</p>
                <input type="text" maxlength=20 id="werteingabeBedingungen" class="werte" oninput="selectChoice()">
            </div>
